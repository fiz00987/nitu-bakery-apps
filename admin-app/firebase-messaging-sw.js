...
var CACHE_NAME = 'nitu-bakery-v13';
// Build stamp — bump on every deploy so you can confirm in DevTools which
// version the browser is actually running.
var ADMIN_BUILD = '2026-09-18-tabs-merge';
try { console.log('Nitu admin build:', ADMIN_BUILD, '— Orders tab merged, badges auto-update'); } catch (e) {}
